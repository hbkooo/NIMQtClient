...
/** @fn void nim_rts_create_conf(const char* name,
 ...
 *				417:提示已经创建好频道
 */
NIM_SDK_DLL_API void nim_rts_create_conf(const char* name,
                                         const char* custom_info,
                                         const char* json_extension,
                                         nim_rts_create_cb_func cb,
                                         const void* user_data);
...
/** @fn void nim_rts_ack(const char* session_id,
                         int channel_type,
                         bool accept,
                         const char* json_extension,
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_rts_ack(const char* session_id,
                                 int channel_type,
                                 bool accept,
                                 const char* json_extension,
                                 nim_rts_ack_res_cb_func cb,
...
// 控制接口
/** @fn void nim_rts_control(const char* session_id,
                             const char* info,
                             const char* json_extension,
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_rts_control(const char* session_id,
                                     const char* info,
                                     const char* json_extension,
                                     nim_rts_control_res_cb_func cb,
                                     const void* user_data);
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_rts_relogin(const char* session_id,
                                     int channel_type,
                                     const char* json_extension,
