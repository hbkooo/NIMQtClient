...
/** @fn HttpRequestHandle nim_http_create_download_file_request(const char *url, const char *download_file_path, nim_http_request_completed_cb
 * complete_cb, const void *user_data) NIM HTTP 创建下载文件任务
 * @param[in] url					资源地址
...
/** @fn HttpRequestHandle nim_http_create_download_file_range_request(const char *url, const char *download_file_path, uint64_t range_start,
 * nim_http_request_completed_cb complete_cb, const void *user_data) NIM HTTP 创建下载文件任务，支持断点续传
 * @param[in] url					资源地址
 * @param[in] download_file_path	下载文件保存的本地路径
...
/** @fn HttpRequestHandle nim_http_create_request(const char* url, const char* post_body, size_t post_body_size, nim_http_request_response_cb
 * response_cb, const void* user_data) NIM HTTP 创建任务
 * @param[in] url				资源地址
...
/** @fn HttpRequestHandle nim_http_create_request_ex(const char* url, const char* post_body, size_t post_body_size, nim_http_request_response_ex_cb
 * response_cb, const void* user_data) NIM HTTP 创建任务
 * @param[in] url				资源地址
 * @param[in] post_body		上传内容
 * @param[in] post_body_size	上传内容大小
 ...
 * @return void					无返回值
 */
NIM_TOOLS_HTTP_EXPORT void nim_http_set_request_progress_cb(HttpRequestHandle request_handle,
 ...
 * @return void					无返回值
 */
NIM_TOOLS_HTTP_EXPORT void nim_http_set_request_speed_cb(HttpRequestHandle request_handle,
 ...
 * @return void					无返回值
 */
NIM_TOOLS_HTTP_EXPORT void nim_http_set_request_transfer_cb(HttpRequestHandle request_handle,
 ...
 * NIM HTTP 设置代理
 * @param[in] request_handle	http任务句柄
 * @param[in] type				代理类型 NIMHttpProxyType
 * @param[in] host				代理地址
 * @param[in] port				代理端口
 * @param[in] user				代理账号
 * @param[in] pass				代理密码
 * @return void				无返回值
 */
NIM_TOOLS_HTTP_EXPORT void nim_http_set_proxy(HttpRequestHandle request_handle,
                                              int type,
                                              const char* host,
                                              short port,
                                              const char* user,
