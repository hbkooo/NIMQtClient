 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_talkex_collect_remove_collects(const char* collect_list,
                                                        nim_talkex_collect_remove_collects_cb_func cb,
                                                        const void* user_data);

/** @fn void nim_talkex_collect_update_collect_ext(const char* collect_match_param,
                                                   const char* ext,
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_talkex_collect_update_collect_ext(const char* collect_match_param,
                                                           const char* ext,
                                                           nim_talkex_collect_update_collect_ext_cb_func cb,
                                                           const void* user_data);

/** @fn void nim_talkex_collect_query_collects(const char* query_collect_list_param,
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_talkex_collect_query_collects(const char* query_collect_list_param,
                                                       nim_talkex_collect_query_collects_cb_func cb,
                                                       const void* user_data);

/** @fn void nim_talkex_quick_comment_add_quick_comment(const char* msg,
                                                        const char* info,
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_talkex_quick_comment_add_quick_comment(const char* msg,
                                                                const char* info,
                                                                nim_talkex_quick_comment_add_quick_comment_cb_func cb,
                                                                const void* user_data);

/** @fn void nim_talkex_quick_comment_remove_quick_comment(const char* msg,
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_talkex_quick_comment_remove_quick_comment(const char* msg,
                                                                   const char* remove_param,
                                                                   nim_talkex_quick_comment_remove_quick_comment_cb_func cb,
                                                                   const void* user_data);

/** @fn void nim_talkex_quick_comment_query_quick_comment(const char* query_param,
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_talkex_quick_comment_query_quick_comment(const char* query_param,
                                                                  nim_talkex_quick_comment_query_quick_comment_cb_func cb,
                                                                  const void* user_data);
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_talkex_quick_comment_reg_add_quick_comment(nim_talkex_quick_comment_add_quick_comment_notify_cb_func cb,
                                                                    const void* user_data);
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_talkex_quick_comment_reg_remove_quick_comment(nim_talkex_quick_comment_remove_quick_comment_notify_cb_func cb,
                                                                       const void* user_data);

/** @fn nim_talkex_pin_message_add_pin_message(const char* msg,
                                               const char* pin_info,
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_talkex_pin_message_add_pin_message(const char* msg,
                                                            const char* pin_info,
                                                            nim_talkex_pin_message_add_pin_message_cb_func cb,
                                                            const void* user_data);
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_talkex_pin_message_unpin_message(const char* modify_param,
                                                          nim_talkex_pin_message_unpin_message_cb_func cb,
                                                          const void* user_data);

/** @fn void nim_talkex_pin_message_update_pin_message(const char* modify_param,
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_talkex_pin_message_update_pin_message(const char* modify_param,
                                                               nim_talkex_pin_message_update_pin_message_cb_func cb,
                                                               const void* user_data);

/** @fn void nim_talkex_pin_message_query_all_pin_message(const char* session,
                                                          int to_type,
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_talkex_pin_message_query_all_pin_message(const char* session,
                                                                  int to_type,
                                                                  const nim_talkex_pin_message_query_all_pin_message_cb_func cb,
                                                                  const void* user_data);
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_talkex_pin_message_reg_update_pin_message(nim_talkex_pin_message_update_pin_message_notify_cb_func cb,
                                                                   const void* user_data);
