 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_doctrans_get_info_list(const char* id,
                                                int32_t limit,
...
/** @fn nim_doctrans_get_page_url(const char* url_prefix,
 ...
 */
NIM_SDK_DLL_API char* nim_doctrans_get_page_url(const char* url_prefix,
                                                NIMDocTranscodingImageType img_type,
                                                NIMDocTranscodingQuality quality,
                                                int32_t page_num);
