...
extern "C" {
#endif
/** @typedef void (*nim_talkex_pin_message_add_pin_message_cb_func)(int code,const char *session,int to_type,
                                                                    const char *pin_info,
 ...
 */
typedef void (
    *nim_talkex_pin_message_add_pin_message_cb_func)(int code, const char* session, int to_type, const char* pin_info, const void* user_data);
...
/** @typedef void (*nim_talkex_pin_message_update_pin_message_cb_func)(int code,
                                                                       const char *session,
                                                                       int to_type,
                                                                       const char *pin_info,
                                                                       const void *user_data)
 ...
 */
typedef void (
    *nim_talkex_pin_message_update_pin_message_cb_func)(int code, const char* session, int to_type, const char* pin_info, const void* user_data);

/** @typedef void (*nim_talkex_pin_message_query_all_pin_message_cb_func)(int code,
                                                                          const char *session,
                                                                          int to_type,
                                                                          const char *pin_list,
                                                                          const void *user_data)
 ...
 */
typedef void (
    *nim_talkex_pin_message_query_all_pin_message_cb_func)(int code, const char* session, int to_type, const char* pin_list, const void* user_data);

/** @typedef void (*nim_talkex_pin_message_add_pin_message_notify_cb_func)(const char *session,
                                                                           int to_type,
                                                                           const char *pin_info,
                                                                           const void *user_data)
...
/** @typedef void (*nim_talkex_pin_message_update_pin_message_notify_cb_func)(const char *session,
                                                                              int to_type,
                                                                              const char *pin_info,
                                                                              const void *user_data)
