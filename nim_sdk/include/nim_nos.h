 ...
 * SDK NOS
 * 模块初始化接口，对上传资源时使用的各场景资源生命周期进行初始化，开发者最多可自定义10个场景，并指定场景资源的生命周期，并可以对缺省场景（kNIMNosDefaultTagResource、kNIMNosDefaultTagIM）进行覆盖（重新指定生命周期）
...
/** @fn nim_nos_download_media(const char* json_msg,
...
/** @fn void nim_nos_upload(const char* local_file,
...
NIM_SDK_DLL_API void nim_nos_upload(const char* local_file,
                                    ...
                                    nim_nos_upload_prg_cb_func prg_cb,
                                    const void* prg_user_data);
/** @fn void nim_nos_upload2(const char* local_file,
                             const char* tag,
                             nim_nos_upload_cb_func res_cb,
                             const void* res_user_data,
                             nim_nos_upload_prg_cb_func prg_cb,
...
NIM_SDK_DLL_API void nim_nos_upload2(const char* local_file,
                                     ...
                                     nim_nos_upload_prg_cb_func prg_cb,
                                     const void* prg_user_data);
/** @fn void nim_nos_download(const char* nos_url,
                              nim_nos_download_cb_func res_cb,
                              const void* res_user_data,
                              nim_nos_download_prg_cb_func prg_cb,
                              const void* prg_user_data)
...
/** @fn void nim_nos_download_media_ex(const char* json_msg,
 ...
 *				其他:参见HTTP协议或CURL错误码
 */
NIM_SDK_DLL_API void nim_nos_download_media_ex(const char* json_msg,
                                               const char* json_extension,
                                               nim_nos_download_cb_func res_cb,
                                               const void* res_user_data,
                                               nim_nos_download_prg_cb_func prg_cb,
...
/** @fn void nim_nos_download_ex(const char* nos_url,
                                 const char* json_extension,
                                 nim_nos_download_cb_func res_cb,
                                 const void* res_user_data,
                                 nim_nos_download_prg_cb_func prg_cb,
 ...
 *				其他:参见HTTP协议或CURL错误码
 */
NIM_SDK_DLL_API void nim_nos_download_ex(const char* nos_url,
                                         const char* json_extension,
                                         nim_nos_download_cb_func res_cb,
                                         const void* res_user_data,
                                         nim_nos_download_prg_cb_func prg_cb,
...
/** @fn void nim_nos_upload_ex(const char* local_file,
                               const char* json_extension,
                               nim_nos_upload_cb_func res_cb,
                               const void* res_user_data,
                               nim_nos_upload_prg_cb_func prg_cb,
 ...
 *				其他:参见HTTP协议或CURL错误码
 */
NIM_SDK_DLL_API void nim_nos_upload_ex(const char* local_file,
                                       const char* json_extension,
                                       nim_nos_upload_cb_func res_cb,
                                       const void* res_user_data,
                                       nim_nos_upload_prg_cb_func prg_cb,
...
/** @fn void nim_nos_upload_ex2(const char* local_file,
                                const char* tag,
                                const char* json_extension,
                                nim_nos_upload_cb_func res_cb,
                                const void* res_user_data,
 ...
 *				其他:参见HTTP协议或CURL错误码
 */
NIM_SDK_DLL_API void nim_nos_upload_ex2(const char* local_file,
                                        const char* tag,
                                        const char* json_extension,
                                        nim_nos_upload_cb_func res_cb,
                                        const void* res_user_data,
...
/** @fn void nim_nos_safeurl_to_originurl(const char* safe_url,
                                          const char* json_extension,
 ...
 */
NIM_SDK_DLL_API void nim_nos_safeurl_to_originurl(const char* safe_url,
                                                  const char* json_extension,
                                                  nim_nos_safeurl_to_originurl_cb_func callback_result,
                                                  const void* user_data);
