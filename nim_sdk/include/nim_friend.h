...
/** @fn void nim_friend_request(const char* accid,
 ...
 *				500:未知错误
 */
NIM_SDK_DLL_API void nim_friend_request(const char* accid,
                                        enum NIMVerifyType verify_type,
                                        const char* msg,
                                        const char* json_extension,
                                        nim_friend_opt_cb_func cb,
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_friend_query_by_keyword(const char* keyword,
                                                 const char* json_extension,
                                                 nim_friend_get_list_cb_func cb,
                                                 const void* user_data);
