...
public:
    ...
    - 主播切观众，本端触发onClientRoleChanged回调，远端触发\ref rtc::IRtcEngineEventHandler::onUserLeft "onUserLeft"回调。
    - 观众切主播，本端触发onClientRoleChanged回调，远端触发\ref rtc::IRtcEngineEventHandler::onUserJoined "onUserJoined"回调。
