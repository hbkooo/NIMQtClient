...
public:
    ...
    */
    ...
    - 该方法与 \ref rtc::IRtcEngine::enableLocalVideo "enableLocalVideo" (false) 的区别在于， \ref rtc::IRtcEngine::enableLocalVideo "enableLocalVideo" (false) 会关闭本地摄像头设备，muteLocalVideoStream不影响本地视频流采集，不禁用摄像头，且响应速度更快。
    ...
    */
    ...
    /** 设置录制的声音格式。
     ...
     该方法设置 \ref rtc::INERtcAudioFrameObserver::onAudioFrameDidRecord "onAudioFrameDidRecord" 回调的录制声音格式。
    ...
    /** 设置播放的声音格式。
     ...
     该方法设置 \ref rtc::INERtcAudioFrameObserver::onAudioFrameWillPlayback "onAudioFrameWillPlayback" 回调的播放声音格式。
    ...
    /** 设置录制和播放声音混音后的采样率。
     ...
     该方法设置 \ref rtc::INERtcAudioFrameObserver::onMixedAudioFrame "onMixedAudioFrame" 回调的声音格式。
    ...
    /** 注册语音观测器对象。
     ...
     该方法用于设置音频采集和播放PCM回调，可用于声音处理等操作。当需要引擎给出 \ref rtc::INERtcAudioFrameObserver::onAudioFrameDidRecord "onAudioFrameDidRecord" 或 \ref rtc::INERtcAudioFrameObserver::onAudioFrameWillPlayback "onAudioFrameWillPlayback" 回调时，需要使用该方法注册回调。
    ...
    /** 
     ...
     - 成功调用该方法后，如果播放状态改变，本地会触发  \ref rtc::IRtcEngineEventHandlerEx::onAudioMixingStateChanged "onAudioMixingStateChanged"  回调。
    ...
    */
    ...
    /**
     ...
     @since V4.3.0
     @param option 发布音视频流的回退选项，默认为不开启回退 kNERtcStreamFallbackAudioOnly。详细信息请参考 {@link RTCStreamFallbackOption}。
    ...
    /**
     ...
     @note 请在加入房间（joinChannel）前调用此方法。
     @since V4.3.0
     @param option 订阅音视频流的回退选项，默认为弱网时回退到视频小流 kNERtcStreamFallbackVideoStreamLow。详细信息请参考 {@link RTCStreamFallbackOption}。
     @return {@code 0} 方法调用成功，其他调用失败
     */
