...
typedef enum
{
    ...
    kNERtcErrChannelMediaRelayInvalidState = 30110,/**< 媒体流转发状态无效 */
    kNERtcErrChannelMediaRelayPermissionDenied = 30111,/**< 媒体流转发权限无效，请检查是否观众模式或者1v1模式 */
    kNERtcErrChannelMediaRelayStopFailed = 30112,/**< 停止媒体流转发失败，请确认已开启媒体流转发 */
