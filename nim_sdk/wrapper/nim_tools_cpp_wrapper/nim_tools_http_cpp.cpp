...
typedef HttpRequestHandle (*typeof_nim_http_create_download_file_range_request)(const char* url, const char* download_file_path, __int64 range_start, nim_http_request_completed_cb complete_cb, const void* user_data);
...
HttpRequest::HttpRequest(const std::string& url, const std::string& download_file_path, const CompletedCallback& complete_cb, const ProgressCallback& progress_cb, const SpeedCallback& speed_cb, const TransferCallback& transfer_cb) {
    ...
    http_reuqest_handle_ = g_nim_http_create_download_file_request(url.c_str(), download_file_path.c_str(), &CompletedCallbackWrapper, complete_cb_userdata);
...
HttpRequest::HttpRequest(const std::string& url, const std::string& download_file_path, __int64 range_start, const CompletedCallback& complete_cb, const ProgressCallback& progress_cb, const SpeedCallback& speed_cb, const TransferCallback& transfer_cb) {
    ProgressCallback* progress_cb_pointer = nullptr;
    if (progress_cb)
        progress_cb_pointer = new ProgressCallback(progress_cb);
    ...
    http_reuqest_handle_ = g_nim_http_create_download_file_range_request(url.c_str(), download_file_path.c_str(), range_start, &CompletedCallbackWrapper, complete_cb_userdata);
...
HttpRequest::HttpRequest(const std::string& url, const char* post_body, size_t post_body_size, const ResponseCallback& response_cb, const ProgressCallback& progress_cb, const SpeedCallback& speed_cb, const TransferCallback& transfer_cb) {
    ProgressCallback* progress_cb_pointer = nullptr;
    if (progress_cb)
        progress_cb_pointer = new ProgressCallback(progress_cb);
    ...
    if (response_cb) {
        ...
        response_cb_userdata->response_cb = [response_cb](bool ret, int code, const std::string& body, const std::string& head) { response_cb(ret, code, body); };
...
HttpRequest::HttpRequest(const std::string& url, const char* post_body, size_t post_body_size, const ResponseCallbackEx& response_cb, const ProgressCallback& progress_cb, const SpeedCallback& speed_cb, const TransferCallback& transfer_cb) {
    ProgressCallback* progress_cb_pointer = nullptr;
    if (progress_cb)
        progress_cb_pointer = new ProgressCallback(progress_cb);
