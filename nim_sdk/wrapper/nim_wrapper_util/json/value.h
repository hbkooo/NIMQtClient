...
#ifndef NIM_CPP_WRAPPER_UTIL_CPPTL_JSON_H_INCLUDED
#define NIM_CPP_WRAPPER_UTIL_CPPTL_JSON_H_INCLUDED
...
template <>
inline void swap(nim_cpp_wrapper_util::Json::Value& a, nim_cpp_wrapper_util::Json::Value& b) {
    a.swap(b);
}
}  // namespace std
...
#endif  // NIM_CPP_WRAPPER_UTIL_CPPTL_JSON_H_INCLUDED
