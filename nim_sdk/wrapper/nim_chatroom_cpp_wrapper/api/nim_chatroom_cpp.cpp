...
typedef void (*nim_chatroom_get_members_by_tag_online_async)(const int64_t room_id, const char* parameters_json_str, const char* json_extension, nim_chatroom_get_members_cb_func cb, const void* user_data);
typedef void (*nim_chatroom_query_members_count_by_tag_async)(const int64_t room_id, const char* target_tag, const char* json_extension, nim_chatroom_query_members_count_by_tag_cb_func cb, const void* user_data);
...
typedef void (*nim_chatroom_temp_mute_member_by_tag_async)(const int64_t room_id, const char* target_tag, const int64_t duration, bool need_notify, const char* notify_ext, const char* notify_tags, const char* json_extension, nim_chatroom_temp_mute_member_cb_func cb, const void* user_data);
...
static void CallbackExit(int64_t room_id, int error_code, int exit_reason, const char* json_extension, const void* user_data) {
    nim::CallbackProxy::DoSafeCallback<ChatRoom::ExitCallback>(user_data, [=](const ChatRoom::ExitCallback& cb) { nim::CallbackProxy::Invoke(cb, room_id, error_code, (NIMChatRoomExitReason)exit_reason); });
}
...
static void CallbackLinkCondition(int64_t room_id, int condition, const char* json_extension, const void* user_data) {
    nim::CallbackProxy::DoSafeCallback<ChatRoom::LinkConditionCallback>(user_data, [=](const ChatRoom::LinkConditionCallback& cb) { nim::CallbackProxy::Invoke(cb, room_id, (NIMChatRoomLinkCondition)condition); });
}
...
std::string ChatRoom::CreateRoomMessage(const NIMChatRoomMsgType msg_type, const std::string& client_msg_id, const std::string& attach, const std::string& msg_body, const ChatRoomMessageSetting& msg_setting, int64_t timetag /* = 0*/, int32_t msg_sub_type /* = 0*/, const std::string& target_tags /* = ""*/) {
...
void ChatRoom::GetMembersOnlineAsync(const int64_t room_id, const ChatRoomGetMembersParameters& parameters, const GetMembersCallback& callback, const std::string& json_extension /* = ""*/) {
...
void ChatRoom::GetMembersByTagOnlineAsync(const int64_t room_id, const ChatRoomGetMembersByTagParameters& parameters, const GetMembersCallback& callback, const std::string& json_extension /* = ""*/) {
    GetMembersCallback* cb_pointer = nullptr;
    if (callback != nullptr)
        cb_pointer = new GetMembersCallback(callback);
...
void ChatRoom::GetMembersCountByTagOnlineAsync(const int64_t room_id, const std::string& target_tag, const GetMembersCountByTagCallback& callback, const std::string& json_extension) {
...
void ChatRoom::GetMessageHistoryOnlineAsync(const int64_t room_id, const ChatRoomGetMsgHistoryParameters& parameters, const GetMsgHistoryCallback& callback, const std::string& json_extension /* = ""*/) {
...
void ChatRoom::SetMemberAttributeOnlineAsync(const int64_t room_id, const ChatRoomSetMemberAttributeParameters& parameters, const SetMemberAttributeCallback& callback, const std::string& json_extension /* = ""*/) {
...
static void CallbackKickMember(int64_t room_id, int error_code, const char* json_extension, const void* user_data) {
    nim::CallbackProxy::DoSafeCallback<ChatRoom::KickMemberCallback>(user_data, [=](const ChatRoom::KickMemberCallback& cb) { nim::CallbackProxy::Invoke(cb, room_id, error_code); });
}
...
void ChatRoom::GetMemberInfoByIDsAsync(const int64_t room_id, const std::list<std::string>& ids, const GetMembersCallback& callback, const std::string& json_extension /* = ""*/) {
    GetMembersCallback* cb_pointer = nullptr;
    if (callback != nullptr)
        cb_pointer = new GetMembersCallback(callback);
...
void ChatRoom::KickMemberAsync(const int64_t room_id, const std::string& id, const std::string& notify_ext, const KickMemberCallback& callback, const std::string& json_extension /* = ""*/) {
...
void ChatRoom::TempMuteMemberAsync(const int64_t room_id, const std::string& accid, const int64_t duration, bool need_notify, const std::string& notify_ext, const TempMuteMemberCallback& callback, const std::string& json_extension /* = ""*/) {
...
void ChatRoom::TempMuteMemberByTagAsync(const int64_t room_id, const std::string& target_tag, const int64_t duration, bool need_notify, const std::string& notify_ext, const TempMuteMemberCallback& callback, const std::string& notify_tags /* = ""*/, const std::string& json_extension /* = ""*/) {
    TempMuteMemberCallback* cb_pointer = nullptr;
    if (callback != nullptr)
        cb_pointer = new TempMuteMemberCallback(callback);
    NIM_CHATROOM_SDK_GET_FUNC(nim_chatroom_temp_mute_member_by_tag_async)
    (room_id, target_tag.c_str(), duration, need_notify, notify_ext.c_str(), notify_tags.c_str(), json_extension.c_str(), &CallbackTempMuteMember, cb_pointer);
}

static void CallbackUpdateRoomInfo(int64_t room_id, int error_code, const char* json_extension, const void* user_data) {
    nim::CallbackProxy::DoSafeCallback<ChatRoom::UpdateRoomInfoCallback>(user_data, [=](const ChatRoom::UpdateRoomInfoCallback& cb) { nim::CallbackProxy::Invoke(cb, room_id, error_code); });
}

static void CallbackUpdateMyRoomRole(int64_t room_id, int error_code, const char* json_extension, const void* user_data) {
    nim::CallbackProxy::DoSafeCallback<ChatRoom::UpdateMyRoomRoleCallback>(user_data, [=](const ChatRoom::UpdateMyRoomRoleCallback& cb) { nim::CallbackProxy::Invoke(cb, room_id, error_code); });
}

static void CallbackQueueOffer(int64_t room_id, int error_code, const char* json_extension, const void* user_data) {
    nim::CallbackProxy::DoSafeCallback<ChatRoom::QueueOfferCallback>(user_data, [=](const ChatRoom::QueueOfferCallback& cb) { nim::CallbackProxy::Invoke(cb, room_id, error_code); });
}

static void CallbackQueueDrop(int64_t room_id, int error_code, const char* json_extension, const void* user_data) {
    nim::CallbackProxy::DoSafeCallback<ChatRoom::QueueDropCallback>(user_data, [=](const ChatRoom::QueueDropCallback& cb) { nim::CallbackProxy::Invoke(cb, room_id, error_code); });
}

void ChatRoom::UpdateRoomInfoAsync(const int64_t room_id, const ChatRoomInfo& info, bool need_notify, const std::string& notify_ext, const UpdateRoomInfoCallback& callback, const std::string& json_extension /* = ""*/) {
...
void ChatRoom::UpdateMyRoomRoleAsync(const int64_t room_id, const ChatRoomMemberInfo& info, bool need_notify, const std::string& notify_ext, const UpdateMyRoomRoleCallback& callback, const std::string& json_extension /* = ""*/) {
...
void ChatRoom::QueueOfferAsync(const int64_t room_id, const ChatRoomQueueElement& element, const QueueOfferCallback& callback, const std::string& json_extension /* = ""*/) {
...
void ChatRoom::QueuePollAsync(const int64_t room_id, const std::string& element_key, const QueuePollCallback& callback, const std::string& json_extension /* = ""*/) {
...
void ChatRoom::QueueBatchUpdateAsync(const int64_t room_id, const ChatRoomBatchMembers& batch_members, bool need_notify, const std::string& notify_ext, const QueueBatchUpdateCallback& callback, const std::string& json_extension) {
