...
void CreateConfCallbackWrapper(int code, const char* json_extension, const void* user_data) {
    CallbackProxy::DoSafeCallback<Rts::CreateConfCallback>(
        user_data, [=](const Rts::CreateConfCallback& cb) { CallbackProxy::Invoke(cb, (nim::NIMResCode)code); }, true);
}
...
void AckCallbackWrapper(int code, const char* session_id, int channel_type, bool accept, const char* json_extension, const void* user_data) {
    CallbackProxy::DoSafeCallback<Rts::AckCallback>(
        user_data,
        [=](const Rts::AckCallback& cb) { CallbackProxy::Invoke(cb, (nim::NIMResCode)code, PCharToString(session_id), channel_type, accept); }, true);
}
...
void SyncAckNotifyCallbackWrapper(const char* session_id, int channel_type, bool accept, const char* json_extension, const void* user_data) {
    CallbackProxy::DoSafeCallback<Rts::SyncAckNotifyCallback>(
        user_data, [=](const Rts::SyncAckNotifyCallback& cb) { CallbackProxy::Invoke(cb, PCharToString(session_id), channel_type, accept); });
}
...
void HangupCallbackWrapper(int code, const char* session_id, const char* json_extension, const void* user_data) {
    CallbackProxy::DoSafeCallback<Rts::HangupCallback>(
        user_data, [=](const Rts::HangupCallback& cb) { CallbackProxy::Invoke(cb, (nim::NIMResCode)code, PCharToString(session_id)); }, true);
}
void HangupNotifyCallbackWrapper(const char* session_id, const char* uid, const char* json_extension, const void* user_data) {
    CallbackProxy::DoSafeCallback<Rts::HangupNotifyCallback>(
        user_data, [=](const Rts::HangupNotifyCallback& cb) { CallbackProxy::Invoke(cb, PCharToString(session_id), PCharToString(uid)); });
}
...
void ControlCallbackWrapper(int code, const char* session_id, const char* info, const char* json_extension, const void* user_data) {
    CallbackProxy::DoSafeCallback<Rts::ControlCallback>(
        user_data,
        [=](const Rts::ControlCallback& cb) { CallbackProxy::Invoke(cb, (nim::NIMResCode)code, PCharToString(session_id), PCharToString(info)); },
        true);
}
