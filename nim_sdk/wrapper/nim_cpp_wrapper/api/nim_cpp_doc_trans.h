...
public:
    ...
    /** @fn std::string GetPageUrl(const std::string& url_prefix, NIMDocTranscodingImageType img_type, NIMDocTranscodingQuality quality,
     int32_t page_num)
     * 拼接文档图片的下载地址
     * @param[in] url_prefix	文档信息中的url前缀
     ...
     */
    static std::string GetPageUrl(const std::string& url_prefix,
