...
static int32_t CallbackBadgeCount(const char* json_extension, const void* user_data) {
    return CallbackProxy::DoSafeCallback<Session::BadgeCountCallback>(
        user_data, [=](const Session::BadgeCountCallback& cb) { return CallbackProxy::Invoke(cb, PCharToString(json_extension)); });
}
    ...
    (
        [](const char* session_id, enum NIMSessionType to_type, const void* user_data) {
            CallbackProxy::DoSafeCallback<CancelStickTopSessionNotifyCallback>(
                user_data, [=](const CancelStickTopSessionNotifyCallback& cb) { CallbackProxy::Invoke(cb, session_id, to_type); }, false);
        },
    ...
    (
        ...
        [](int rescode, const char* session_id, enum NIMSessionType to_type, const void* user_data) {
            CallbackProxy::DoSafeCallback<CancelStickTopSessionCallback>(
                user_data, [=](const CancelStickTopSessionCallback& cb) { CallbackProxy::Invoke(cb, (nim::NIMResCode)rescode, session_id, to_type); },
                true);
        },
        cb_pointer);
}
    ...
    (
        ...
        [](int rescode, const SessionRoamMsgHasMoreTagInfo* tag_info, const void* user_data) {
            CallbackProxy::DoSafeCallback<QueryHasmoreRoammsgCallback>(
                user_data, [=](const QueryHasmoreRoammsgCallback& cb) { CallbackProxy::Invoke(cb, (nim::NIMResCode)rescode, *tag_info); }, true);
        },
        cb_pointer);
}
    ...
    (
        [](int rescode, const SessionRoamMsgHasMoreTagInfo* tag_info_list, int size, const void* user_data) {
            ...
            CallbackProxy::DoSafeCallback<QueryAllHasmoreRoammsgCallback>(
                user_data, [=](const QueryAllHasmoreRoammsgCallback& cb) { CallbackProxy::Invoke(cb, (nim::NIMResCode)rescode, info_list); }, true);
        },
        cb_pointer);
}
    ...
    (
        ...
        [](int rescode, const void* user_data) {
            CallbackProxy::DoSafeCallback<UpdateHasmoreRoammsgCallback>(
                user_data, [=](const UpdateHasmoreRoammsgCallback& cb) { CallbackProxy::Invoke(cb, (nim::NIMResCode)rescode); }, true);
        },
        cb_pointer);
}
    ...
    (
        ...
        [](int rescode, const void* user_data) {
            CallbackProxy::DoSafeCallback<DeleteHasmoreRoammsgCallback>(
                user_data, [=](const DeleteHasmoreRoammsgCallback& cb) { CallbackProxy::Invoke(cb, (nim::NIMResCode)rescode); }, true);
        },
        cb_pointer);
}
